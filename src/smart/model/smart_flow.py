...
from src.smart.modules.draft_physics_soft_limit import (
    SoftLimitTopKDraftPhysicsRegularizer as DraftPhysicsRegularizer,
)
...
class SMARTFlow(LightningModule):
    ...
    def _switch_module_to_eval_preserving_modes(module: nn.Module) -> Dict[nn.Module, bool]:
        """하위 모듈의 train/eval 상태를 저장한 뒤 전체 모듈을 eval로 전환합니다."""
    ...
    def _restore_module_training_modes(training_modes: Dict[nn.Module, bool]) -> None:
        """저장해 둔 하위 모듈별 train/eval 상태를 복원합니다."""
