...
from src.smart.layers.segmented_graph_attention import GraphAttentionMetadata
...
class _CudaSegmentedGraphAttention(torch.autograd.Function):
    ...
    relation projections are recomputed once in backward, avoiding repeated
    chunk-level ``autograd.grad`` calls.
    """
