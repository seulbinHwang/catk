...
class DynamicsAwareFeasibleCommitBridge:
    ...
    def __init__(
        ...
        stationary_speed_exit_mps: float = 0.075,
        stationary_yaw_rate_enter_radps: float = 0.1,
        stationary_yaw_rate_exit_radps: float = 0.15,
        stationary_displacement_enter_m: float = 0.04,
        stationary_displacement_exit_m: float = 0.06,
        stationary_path_length_enter_m: float = 0.08,
        stationary_path_length_exit_m: float = 0.12,
        stationary_heading_enter_rad: float = 0.05,
        stationary_heading_exit_rad: float = 0.075,
