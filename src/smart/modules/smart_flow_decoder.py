...
class SMARTFlowDecoder(nn.Module):
    ...
    def __init__(
        ...
        self.agent_encoder = SMARTFlowAgentDecoder(
            ...
            flow_use_future_mixer=flow_use_future_mixer,
            flow_future_mixer_mlp_expansion=flow_future_mixer_mlp_expansion,
            flow_future_mixer_checkpoint=flow_future_mixer_checkpoint,
            flow_future_mixer_attention_backend=flow_future_mixer_attention_backend,
