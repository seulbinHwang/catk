...
class EpochLastCheckpointCallback(Callback):
    ...
    def on_train_batch_end(
        ...
        # Lightning runs fit-time validation before `on_train_epoch_end`, so save here on the final
        # training batch to keep `epoch_last.ckpt` resumable even while validation is still pending.
