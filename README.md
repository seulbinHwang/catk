...
| H100 4+2 DDP smoke | train 1 batch + validation 1 batch, top-12 closed-loop sampling | open-loop validation, closed-loop Fast WOSAC logging 모두 정상 종료, `run.py DONE` |
