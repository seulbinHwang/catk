...
- `data.train_batch_size: 2`, `trainer.accumulate_grad_batches: 13`, 즉 8개 rank
  기준 effective global batch 208
...
- `data.val_batch_size: 2`, `data.test_batch_size: 2`, `num_workers: 4`
