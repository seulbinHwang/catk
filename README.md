...
- 지연 기준 시점의 context는 자기 생성 0.5초 chunk로 다시 고른 motion token id를 사용합니다.
- traffic-light 시간차도 지연 기준 시점에 맞춰 다시 계산해 map-agent relation encoder에 넘깁니다.
...
상세 설명은 `docs/DELAYED_SELF_FORCING_USAGE.md`와
`docs/DELAYED_SELF_FORCING_REVIEW_FIX.md`에 있습니다.
