...
- global train batch: `8 x 14 = 112`, H100x4 preset의 `28 x 4 = 112`와 같습니다.
...
python scripts/launch_self_forced_sid_v100x7x2_static_pods.py \
  ...
  --limit-val-batches 0 \
  --max-epochs 1 \
  --task-name flow_self_forced_sid_v100x7x2_unfrozen_except_map_encoder_estimator_warmup_1_bs8_smoke
```
