...
tmux new-session -d -s catk-v100x47-stable-original-latest-controller \
  -c "$PWD" \
...
```bash
kubectl exec -it -n p-pnc sv -c main -- tmux attach -t catk-control-pretrain-v100x47-prefix-default-noslip-tailprefix-stable-original-latest
kubectl exec -it -n p-pnc fv -c main -- tmux attach -t catk-control-pretrain-v100x47-prefix-default-noslip-tailprefix-stable-original-latest
```
