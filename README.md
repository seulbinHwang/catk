...
| decoder | `hidden_dim=128`, `num_heads=8`, `head_dim=15`, `num_map_layers=3`, `num_agent_layers=6` |
| model parameters | `8,365,489` total / trainable, 직접 SMART instantiate로 측정 |
