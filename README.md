...
semi_control_decoder의 decoder-agent-attention fm-sf-6 실험은 같은 sidecar fast path를 아래 wrapper로 씁니다.

```bash
python scripts/launch_pre_bc_flow_decoder_agent_attention_h100x8_fmsf6_sidecar_static_pod.py --replace
```
