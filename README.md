...
| description | `flow_control_space_pretrain_h100x4_h100x2_prefix_default_noslip_tailprefix_roundtrip05_lr6e-4_bs20_epoch061_true_1.016` |
| account | `h.sb@naverlabs.com` |
| default validation batch | per-rank `val_batch_size=48` |
| tmux session | `catk-flow-waymo-val-submission-epoch061-h100x6-hsb1` |
...
kubectl exec -it -n p-pnc hsb-npc-training-1 -c main -- \
  tmux attach -t catk-flow-waymo-val-submission-epoch061-h100x6-hsb1
```
