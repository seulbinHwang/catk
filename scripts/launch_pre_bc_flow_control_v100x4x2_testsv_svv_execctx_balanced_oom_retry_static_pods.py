#!/usr/bin/env python3
"""Launch V100x4x2 execution-context pretrain on testsv + svv.

This is the pod-specific entrypoint for the semi_control_rolling_gan V100x4x2
experiment that should run on the already-running ``testsv`` and ``svv`` pods.
...
base.DEFAULT_PODS = ("testsv", "svv")
base.DEFAULT_TASK_NAME = (
    "flow_control_space_pretrain_v100x4x2_testsv_svv_"
    "execctx_prefix_balanced_lr2e-4_bs2_accum7_oomretry"
)
base.DEFAULT_SESSION = "catk-control-pretrain-v100x4x2-testsv-svv-execctx-balanced"
