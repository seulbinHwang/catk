#!/usr/bin/env python3
"""Recover, archive, and optionally upload a testa/testaa Waymo submission.
...
def main() -> None:
    ...
    parser.add_argument("--project-root", default="/tmp/catk_smart_branch_a100x4x2_pretrain")
    ...
    parser.add_argument("--method-name", default="SMART-NTP-7M")
