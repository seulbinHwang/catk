...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--generated-estimator-learning-rate", default="")
    parser.add_argument("--estimator-warmup-epochs", type=int, default=2)
    ...
    parser.add_argument("--closed-loop-sf-global-max-step", type=int, default=1)
