#!/usr/bin/env python3
"""Launch stride-1 multi-anchor closed-loop DMD self-forcing on fm-sf-4 H100x8."""
...
def main() -> int:
    ...
    args = [
        ...
        (
            ...
            "activecontrol_sample16_backprop8_lr5e-5_bs8to6_frac025_ep6_warm2_global2_local4"
        ),
        "--session",
