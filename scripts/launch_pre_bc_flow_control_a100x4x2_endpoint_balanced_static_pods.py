...
DEFAULT_EXPERIMENT = "pre_bc_flow_control_a100x4x2_endpoint_balanced"
DEFAULT_TASK_NAME = (
    "flow_control_space_pretrain_a100x4x2_endpoint_substep_balanced_lr6e-4_bs26"
)
DEFAULT_SESSION = "catk-control-pretrain-a100x4x2-endpoint-balanced"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Launch A100x4x2 0.5s endpoint+substep control-space pretrain "
            "on testa and testaa."
        )
    )
    ...
    parser.add_argument("--branch", default=os.environ.get("CATK_BRANCH") or "semi_control_rolling_0.5")
    parser.add_argument(
        "--git-ref",
    ...
    parser.add_argument("--master-port", default="29581")
    parser.add_argument("--checkpoint-sync-port", default="29582")
