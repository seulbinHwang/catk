#!/usr/bin/env python3
"""Launch stride-1 multi-anchor DMD self-forcing on fm-sf-2 H100x8 with no estimator warmup."""
...
def main() -> int:
    ...
    args = [
        ...
        "--pretrain-ckpt",
        (
            "/workspace/flow_self_forced_dmd_h100x8_fmsf2_pretrain_epoch061_x5f9g0ce/"
            "v57/epoch_061.ckpt"
        ),
        ...
        "--task-name",
        (
            "flow_self_forced_dmd_h100x8_fmsf2_sfanchor_stride1_epoch061_x5f9g0ce_"
            "activecontrol_sample16_backprop8_lr5e-5_bs8to6_frac025_ep6_warm0_middle_val1_agent_oomretry"
        ),
        "--session",
        "catk-self-forced-dmd-h100x8-fmsf2-sfanchor-stride1-warm0-lr5e5",
        "--initial-bs",
        "8",
        "--oom-step",
        "2",
