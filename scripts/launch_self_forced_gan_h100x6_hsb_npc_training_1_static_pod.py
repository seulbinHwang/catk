...
base.DEFAULT_TRAIN_BATCH_SIZE = 1
base.DEFAULT_ACCUMULATE_GRAD_BATCHES = 16
base.DEFAULT_VAL_BATCH_SIZE = 16
base.DEFAULT_PRECISION = "bf16-mixed"
base.DEFAULT_TEACHER_CACHE_GPUS_PER_POD = 6
base.DEFAULT_TEACHER_CACHE_BATCH_SIZE = 32
base.DEFAULT_TEACHER_CACHE_ROLLOUT_BATCH_SIZE = 32
base.DEFAULT_TEACHER_CACHE_DATA_NUM_WORKERS = 2
base.DEFAULT_TEACHER_CACHE_DATA_PREFETCH_FACTOR = 2
base.DEFAULT_TEACHER_CACHE_SAVE_WORKERS = 8
base.DEFAULT_TEACHER_CACHE_AMP_DTYPE = "float16"
