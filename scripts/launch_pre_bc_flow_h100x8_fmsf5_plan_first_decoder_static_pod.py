...
DEFAULT_BRANCH = "semi_control_decoder_gpt"
...
DEFAULT_TASK_NAME = (
    "flow_open_loop_pretrain_planfirst_residual_decoder_"
    "h100x8_fmsf5_bs18_lr6p5e-4_warm5_val8_membal"
)
DEFAULT_SESSION = "catk-pretrain-planfirst-decoder-h100x8-fmsf5"
