#!/usr/bin/env python3
"""Launch the epoch-116 H100x6 Waymo validation antithetic-noise1000 preset.

This wrapper reuses the guarded epoch-61 validation launcher while pinning the
checkpoint and iid Gaussian antithetic inference preset selected for validation
