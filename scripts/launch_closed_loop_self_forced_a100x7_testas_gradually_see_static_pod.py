#!/usr/bin/env python3
"""Launch the testa+testaa A100x4x2 closed-loop run variant on testas with gradually_see=true."""
...
def main() -> int:
    ...
    task_name = (
        ...
        "graduallysee_1e1dec_lrdecay001_resume_e5_"
        f"{timestamp}"
    )
    args = [
        sys.executable,
        ...
        task_name,
        "--session",
        "catk-clsf-testas-g4-seeall-graduallysee-lrdecay001",
        "--initial-action",
        "fit",
        "--initial-bs",
        "72",
