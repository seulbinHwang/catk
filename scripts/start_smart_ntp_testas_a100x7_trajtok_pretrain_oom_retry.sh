...
export PROJECT_ROOT="${PROJECT_ROOT:-/tmp/catk_smart_ntp_testas_a100x7_trajtok_upgrade_paperlock}"
export BRANCH="${BRANCH:-trajtok_upgrade}"
export TASK_NAME="${TASK_NAME:-trajtok_upgrade_paperlock_pretrain_testas_a100x7_gbs${EFFECTIVE_BS}_lr595e4_oom_retry}"
export SESSION="${SESSION:-catk-smart-ntp-testas-a100x7-trajtok-upgrade-paperlock}"
...
export TRAJTOK_AGENT_TOKEN_FILE="${TRAJTOK_AGENT_TOKEN_FILE:-trajtok_paperlock_vocab.pkl}"
export TRAJTOK_AGENT_SIDECAR_DIR="${TRAJTOK_AGENT_SIDECAR_DIR:-${CACHE_ROOT}/trajtok_paperlock_agent_token_sidecar/training}"
...
TRAJTOK_OVERRIDES=(
  ...
  "model.model_config.token_processor.agent_token_file=${TRAJTOK_AGENT_TOKEN_FILE}"
