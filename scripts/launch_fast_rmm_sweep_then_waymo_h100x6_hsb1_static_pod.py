...
DEFAULT_SWEEP_GROUP = "fast_rmm_epoch_sweep_h100x6_hsb1_rmm_only_bs48"
DEFAULT_SUBMISSION_TASK = "flow_control_waymo_val_best_rmm_h100x6_hsb1"
DEFAULT_SUBMISSION_GROUP = "waymo_submission_best_rmm_h100x6_hsb1"
...
def launch_sweep(args: argparse.Namespace) -> None:
    command = [
        sys.executable,
        script_path("launch_fast_rmm_epoch_sweep_h100x6_hsb1_static_pod.py"),
        "--namespace",
        args.namespace,
        "--container",
        args.container,
...
def launch_submission(args: argparse.Namespace) -> None:
    command = [
        sys.executable,
        script_path("launch_waymo_submission_from_best_h100x6_hsb1_static_pod.py"),
        "--namespace",
        args.namespace,
        "--container",
        args.container,
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Launch Fast-RMM epoch sweep on hsb-npc-training-1, wait for the "
    ...
    parser.add_argument("--branch", default="semi_control_rolling")
    ...
    parser.add_argument("--sweep-val-batch-size", type=int, default=48)
    parser.add_argument("--sweep-limit-val-batches", default="auto")
    parser.add_argument("--submission-val-batch-size", type=int, default=48)
