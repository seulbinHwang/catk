#!/usr/bin/env python3
"""Launch the fm-sf-4 H100x8 injection-ramp variant of the fm-sf-3 gradually-see run."""
...
def main() -> int:
    ...
    task_name = (
        ...
        f"{lr_tag}_bs20to4step4_frac025_ep6_warm0_global{closed_loop_sf_global_max_step}_local4"
    )
    ...
    args = [
        ...
        task_name,
        "--session",
        f"catk-closed-loop-sf-h100x8-fmsf4-gradual-injramp-stride{rollout_anchor_stride}",
        "--initial-bs",
        "20",
        "--oom-step",
        "4",
