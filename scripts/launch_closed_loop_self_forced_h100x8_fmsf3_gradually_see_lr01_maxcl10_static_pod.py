#!/usr/bin/env python3
"""Launch the fm-sf-3 H100x8 gradually-see maxcl10 run with LR final ratio 0.1."""
...
DEFAULT_PROJECT_ROOT = "/tmp/catk_self_forcing_closed_loop_fmsf3_graduallysee_lr01_maxcl10"
DEFAULT_LOG_DIR = "/tmp/catk_self_forcing_closed_loop_logs"
DEFAULT_SESSION = "catk-clsf-h100x8-fmsf3-graduallysee-maxcl10-lrdecay01"
...
def main() -> int:
    ...
    task_name = (
        "flow_closed_loop_self_forced_h100x8_fmsf3_g4_seeall_"
