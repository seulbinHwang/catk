#!/usr/bin/env python3
"""Launch beta=0.8 stride-1 DMD self-forcing on fm-sf-6 H100x8 for one epoch."""
...
DEFAULT_EXTRA_OVERRIDES = " ".join(
    [
        ...
        "model.model_config.self_forced.beta=0.8",
...
def main() -> int:
    ...
    args = [
        ...
        "--pretrain-ckpt",
        (
            "/workspace/flow_self_forced_dmd_h100x8_fmsf6_pretrain_epoch061_x5f9g0ce/"
            "v57/epoch_061.ckpt"
        ),
        ...
        "--task-name",
        (
            "flow_self_forced_dmd_h100x8_fmsf6_sfanchor_stride1_beta08_epoch061_x5f9g0ce_"
            "activecontrol_sample16_backprop8_lr5e-5_bs5to2_frac025_ep1_warm0_middle_val1_agent_oomretry"
        ),
        "--session",
        "catk-self-forced-dmd-h100x8-fmsf6-sfanchor-stride1-warm0-beta08-ep1-lr5e5",
        "--initial-bs",
        "5",
        "--oom-step",
        "1",
