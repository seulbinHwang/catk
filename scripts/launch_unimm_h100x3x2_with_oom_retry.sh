...
# CUDA OOM fallback.
#
# The first attempt starts at INITIAL_BS=24 by default. If any pod log contains
...
BRANCH="${BRANCH:-UniMM}"
TASK_NAME="${TASK_NAME:-unimm_anchor_based_4s_h100x3x2_pretrain_globalbs144_oom_retry}"
...
LEARNING_RATE="${LEARNING_RATE:-0.001060660172}"
