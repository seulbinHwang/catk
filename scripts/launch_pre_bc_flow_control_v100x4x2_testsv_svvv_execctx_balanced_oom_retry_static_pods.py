#!/usr/bin/env python3
"""Launch V100x4x2 execution-context pretrain on testsv + svvv.

This is the pod-specific entrypoint for the semi_control_rolling_gan V100x4x2
experiment that should run on the already-running ``testsv`` and ``svvv`` pods.
...
base.DEFAULT_PODS = ("testsv", "svvv")
base.DEFAULT_TASK_NAME = (
    "flow_control_space_pretrain_v100x4x2_testsv_svvv_"
    "execctx_prefix_balanced_lr2e-4_bs2_accum7_oomretry"
)
base.DEFAULT_SESSION = "catk-control-pretrain-v100x4x2-testsv-svvv-execctx-balanced"
