...
CANDIDATES = [
    ...
    Candidate(
        ...
        estimator_lr="1.0e-7",
        beta="1.25",
        notes="RMM low with enough CPD: sharpen DMD direction.",
    ),
    Candidate(
        name="lr5e8_beta1p25",
        lr="5.0e-8",
        estimator_lr="5.0e-8",
        beta="1.25",
        notes="Combine lower LR and sharper beta.",
    ),
    Candidate(
        ...
        use_anchor="true",
        anchor_weight="0.05",
        notes="Add light anchor FM regularization.",
    ),
    Candidate(
        name="lr2e8_beta1p25_anchor005",
        lr="2.0e-8",
        estimator_lr="2.0e-8",
        beta="1.25",
        use_anchor="true",
        anchor_weight="0.05",
        notes="Last conservative attempt: lower LR, sharpened beta, light anchor.",
    ),
]
