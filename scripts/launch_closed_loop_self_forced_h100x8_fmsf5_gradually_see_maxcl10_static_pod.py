#!/usr/bin/env python3
"""Launch the testas gradually-see closed-loop recipe on fm-sf-5 with 10 closed-loop epochs."""
...
DEFAULT_SESSION = "catk-clsf-h100x8-fmsf5-graduallysee-maxcl10-lrdecay001"
...
def main() -> int:
    ...
    task_name = (
        ...
        "graduallysee_1e1dec_lrdecay001_resume_e5_maxcl10_"
        f"{timestamp}"
    )
    args = [
        sys.executable,
