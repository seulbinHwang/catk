#!/usr/bin/env python3
"""Launch the fm-sf-3 see-all maxcl10 recipe on testas with LR final ratio 0.1."""
...
DEFAULT_PROJECT_ROOT = "/tmp/catk_self_forcing_closed_loop_testas_seeall_lrdecay01_maxcl10"
DEFAULT_SESSION = "catk-clsf-testas-g4-seeall-maxcl10-lrdecay01"
...
DEFAULT_EXTRA_OVERRIDES = " ".join(
    [
        ...
        "model.model_config.self_forced.gradually_see=false",
...
def main() -> int:
    ...
    task_name = (
        "flow_closed_loop_self_forced_a100x7_testas_g4_seeall_"
