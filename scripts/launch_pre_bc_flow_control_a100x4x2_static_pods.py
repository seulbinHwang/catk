#!/usr/bin/env python3
"""Launch A100x4x2 kinematic control-space pretrain on testa/testaa.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Launch A100x4x2 kinematic control-space prefix-valid pretrain "
            "on testa and testaa."
        )
    )
    ...
    parser.add_argument(
        "--pods",
        nargs="+",
        default=os.environ.get("PODS", "testa testaa").split(),
    )
    ...
    parser.add_argument(
        "--task-name",
        default="flow_control_space_pretrain_a100x4x2_prefix_roundtrip2_lr6e-4_bs26",
    )
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "the base launcher uses /workspace/womd_v1_3/SMART_cache."
        ),
    )
    parser.add_argument(
        "--replace",
