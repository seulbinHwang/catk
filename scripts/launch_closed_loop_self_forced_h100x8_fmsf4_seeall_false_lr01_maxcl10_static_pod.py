#!/usr/bin/env python3
"""Launch the fm-sf-4 H100x8 see_all=false maxcl10 run with LR final ratio 0.1."""
...
def main() -> int:
    ...
    args = [
        ...
        "main",
        "--project-root",
        "/tmp/catk_self_forcing_closed_loop_fmsf4_seeallfalse_lrdecay01_maxcl10",
        "--branch",
        "self_forcing_closed_loop",
        "--pull",
        "--replace",
        "--session",
        "catk-closed-loop-sf-g4-seeallfalse-lrdecay01-maxcl10-fmsf4",
        "--task-name",
        task_name,
        "--experiment",
