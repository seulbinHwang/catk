...
DEFAULT_METADATA_CACHE_BASENAME = (
    "womd_training_memory_balance_v1_stable_original_latest.pt"
)
...
def parse_args() -> tuple[argparse.Namespace, list[str]]:
    parser = argparse.ArgumentParser(
        description=(
            "Launch the latest semi_control_stable_original V100x47 tail-prefix "
            "Flow pretrain. Unknown arguments are passed through to the base launcher."
        )
    )
