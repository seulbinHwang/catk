...
PROJECT_ROOT="${PROJECT_ROOT:-/tmp/catk_smart_ntp_h100x4_h100x2_trajtok_fulltraj_20260605}"
REPO_URL="${REPO_URL:-https://github.com/seulbinHwang/catk.git}"
BRANCH="${BRANCH:-trajtok}"
GIT_REF="${GIT_REF:-}"
TASK_NAME="${TASK_NAME:-smart_ntp_pretrain_h100x4_h100x2_globalbs108_lr581e4_oom_retry_trajtok_hidden128_fulltraj_topk12_trainselectfalse_20260605}"
SESSION="${SESSION:-catk-smart-ntp-h100x4-h100x2-trajtok-fulltraj-gbs108-lr581e4}"
