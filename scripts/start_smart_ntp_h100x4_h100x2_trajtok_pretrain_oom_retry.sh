...
GIT_REF="${GIT_REF:-}"
TASK_NAME="${TASK_NAME:-smart_ntp_pretrain_h100x4_h100x2_globalbs90_lr685e4_oom_retry_trajtok_hidden124_tokenmatchopt_trainselectfalse_20260603}"
SESSION="${SESSION:-catk-smart-ntp-h100x4-h100x2-trajtok-tokenmatchopt-gbs90}"
