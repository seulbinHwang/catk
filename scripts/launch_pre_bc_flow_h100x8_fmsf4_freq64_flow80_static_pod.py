#!/usr/bin/env python3
"""Launch an H100x8 open-loop Flow pretrain on the existing fm-sf-4 pod.
...
DEFAULT_TASK_NAME = (
    "flow_open_loop_pretrain_freq64_flow80_"
    "h100x8_fmsf4_bs18_lr6p5e-4_warm5_val8_membal"
)
DEFAULT_SESSION = "catk-pretrain-freq64-flow80-h100x8-fmsf4"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Launch fm-sf-4 H100x8 open-loop pretrain for freq64 + flow80 test."
    )
